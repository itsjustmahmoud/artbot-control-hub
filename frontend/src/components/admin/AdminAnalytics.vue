    ...
    <div class="analytics-grid">
      ...
      <div class="analytics-card">
        <div class="card-header">
          ...
          <span class="status-indicator active">{{ totalRobots }} Total</span>
        </div>
        <div class="stats-grid">
          <div class="stat-item">
            <div class="stat-number">{{ Math.round(totalRobots * 0.85) }}</div>
          ...
          <div class="stat-item">
            <div class="stat-number">{{ Math.round(totalRobots * 0.72) }}</div>
