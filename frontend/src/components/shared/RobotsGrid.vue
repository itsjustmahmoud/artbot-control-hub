  ...
  <section class="robots-section">
    <div class="section-header">
      ...
      <div class="header-controls">
        ...
        <div v-if="showAdminControls" class="fleet-actions">
          <button class="action-btn primary" @click="$emit('add-robot')">Add Robot</button>
          <button class="action-btn secondary" @click="$emit('bulk-actions')">Bulk Actions</button>
          <button class="action-btn secondary" @click="$emit('export-data')">Export Data</button>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    handleViewLogs(robotId) {
      this.$emit('view-logs', robotId)
    },
    handleDelete(robotId) {
      this.$emit('delete-robot', robotId)
    }
  }
}
</script>
